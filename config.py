...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "6931355424:AAEyxsy5B7onPBsVDhNH2tzAsZzXJ_JFzEs")
...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002056431118"))

# NAMA OWNER
OWNER = os.environ.get("OWNER", "brain485")

#OWNER ID
OWNER_ID = int(os.environ.get("OWNER_ID", "6452097643"))

#Port
PORT = os.environ.get("PORT", "4563")

#Database
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://harshsharma:harsh@harshsharma.2jstkwo.mongodb.net/")
DB_NAME = os.environ.get("DATABASE_NAME", "boobiediary")

#force sub channel id, if you want enable force sub
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002139953393"))
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1002181869113"))
...
try:
    ADMINS=[6376328008]
    for x in (os.environ.get("ADMINS", "6968641742").split()):
        ADMINS.append(int(x))
except ValueError:
